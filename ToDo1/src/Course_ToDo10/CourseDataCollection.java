...
private static Map<Integer, Course> allAvailableCourses;
	...
	static {
		...
		allAvailableCourses.put(101, new Course(101,"C++",108,"Udemy",10000));
		allAvailableCourses.put(102, new Course(102,"C",108,"Coursera",10000));
		allAvailableCourses.put(103, new Course(103,"Java",108,"Udemy",10000));
		allAvailableCourses.put(104, new Course(104,"Python",108,"Udemy",10000));
		allAvailableCourses.put(105, new Course(105,"Angular",108,"Coursera",10000));
	}
	...
	public void addNewCourse()
	{
		...
		allAvailableCourses.put(courseId, new Course(courseId, courseTitle, courseDuration, courseProvider, courseFees));
	}
